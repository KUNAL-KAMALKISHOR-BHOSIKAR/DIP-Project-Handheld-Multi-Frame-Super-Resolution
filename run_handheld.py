...
if __name__ == "__main__":
    ...
    parser.add_argument('--do_clahe', type=str2bool, default=False, help='Whether clahe should be applied during post processing')
    parser.add_argument('--do_edge_detection', type=str2bool, default=False, help='Whether edge detection should be applied during post processing')
    parser.add_argument('--do_bilateral', type=str2bool, default=False, help='Whether bilateral filtering should be applied during post processing')
    parser.add_argument('--do_hsv', type=str2bool, default=False, help='Whether HSV toning should be applied during post processing')
    ...
    params['post processing'] = {'on':args.post_process,
                        ...
                        'do clahe': args.do_clahe,
                        'do edge detection': args.do_edge_detection,
                        'do bilateral': args.do_bilateral,
                        'do hsv': args.do_hsv,
